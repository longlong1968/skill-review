...
│   └── skill-foundry-modification-plan.zh.md  # Blueprint for "Skill Foundry" workflow
└── README.md                         # This file
```
...
- **`references/skill-foundry-modification-plan.zh.md`** — A higher-level proposal for a complete skill refactoring workflow ("Skill Foundry"). `skill-review` serves as the structural review module within that larger pipeline.
